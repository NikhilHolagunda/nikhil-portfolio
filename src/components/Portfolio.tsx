...
const PROJECTS: {
  ...
  },
  {
    title: "CropCast",
    tag: "ML · LIVE DEMO",
    desc: "Live ML: Random Forest predicts the best crop from soil + weather. 98.6% accuracy across 22 crops. FastAPI backend on Render, React frontend on Vercel.",
    tech: ["Python", "Scikit-learn", "FastAPI", "React", "Render"],
    color: "#46D369",
    year: "2025",
    match: "98%",
    github: "https://github.com/NikhilHolagunda/cropcast",
    demo: "https://cropcast-app-two.vercel.app",
  },
  {
    title: "EventHub",
    tag: "ENTERPRISE",
  ...
  },
  {
    title: "DataDash",
    tag: "DATA VIZ · LIVE",
    desc: "Interactive sales analytics dashboard — KPIs, revenue trends, category drill-down, top customers. React + Recharts frontend, Flask + PostgreSQL backend.",
    tech: ["React", "Vite", "Recharts", "Flask", "PostgreSQL"],
    color: "#00D4FF",
    year: "2026",
    match: "97%",
    github: "https://github.com/NikhilHolagunda/datadash",
    demo: "https://datadash-tawny.vercel.app",
  },
  {
    title: "TaskFlow",
    tag: "KANBAN · LIVE",
    desc: "Full-stack kanban board with JWT auth, drag-and-drop, and persistent state. FastAPI + PostgreSQL backend, React + dnd-kit frontend.",
    tech: ["React", "Vite", "dnd-kit", "FastAPI", "PostgreSQL", "JWT"],
    color: "#E876FF",
    year: "2026",
    match: "96%",
    github: "https://github.com/NikhilHolagunda/taskflow",
    demo: "https://taskflow-rho-neon.vercel.app",
  },
  {
